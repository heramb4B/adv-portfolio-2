      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="animate-fade-in">
            <h2 className="text-4xl font-bold text-[#1a237e] serif-font mb-6">Get In Touch</h2>
            <p className="text-gray-600 mb-12 text-lg">
              To schedule a consultation or inquire about legal representation at the District and Sessions Court, Buldhana, please use the form or reach out directly.
            </p>
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">District & Sessions Court Premises, Buldhana, Maharashtra - 443001</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">shialdeshmukh2905@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-8 md:p-10 rounded-xl shadow-lg border border-gray-100">
            {submitted ? (
              <div className="flex flex-col items-center justify-center py-12 text-center animate-fade-in">
                ...
                <h3 className="text-2xl font-bold text-[#1a237e] mb-2">Message Sent!</h3>
                <p className="text-gray-600">Thank you for reaching out. Adv. Shital Deshmukh's office will contact you shortly.</p>
              </div>
            ) : (
